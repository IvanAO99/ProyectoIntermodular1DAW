    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (usuarioSesion == null || usuarioSesion.isAnonimo()) {
                ...
                if (pedidoAFacturar == null || (!pedidoAFacturar.perteneceAUsuario(usuarioSesion) && !usuarioSesion.isAdmin())) {
                    ...
                    if (dirEnvio == null || (!dirEnvio.perteneceA(usuarioSesion) && !usuarioSesion.isAdmin())) {
                        ...
                        Pedido pedidoFacturado = new Pedido(pedidoAFacturar.getCodigo(), pedidoAFacturar.getFecha(), pedidoAFacturar.getUsuario(), pedidoAFacturar.getMetodoPago(), pedidoAFacturar.getDireccion(), pedidoAFacturar.getLineasPedido(), true);
                        Factura factura = new Factura(facturaDAO.siguienteCodigo(), LocalDateTime.now(), dirEnvio, pedidoFacturado);
