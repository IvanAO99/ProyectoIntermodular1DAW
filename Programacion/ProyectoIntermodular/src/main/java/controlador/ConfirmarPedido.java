    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (usuarioSesion == null || usuarioSesion.isAnonimo()) {
                ...
                Pedido pedido = new Pedido(pedidoDAO.siguienteCodigo(), LocalDateTime.now(), usuarioSesion, carrito.getMetodoPago(), carrito.getDireccion(), carrito.getLineasPedido(), false);
