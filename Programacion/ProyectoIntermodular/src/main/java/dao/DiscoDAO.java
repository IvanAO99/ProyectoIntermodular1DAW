...
public class DiscoDAO extends TablaDAO<Producto> {
    ...
    public ArrayList<Producto> getAll() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            lista.add(new Disco(codigo, nombre, descripcion, precio, unidadDeMedida, iva, stock, stockMinimo, foto, usuarioCrea, fechaCreacion, usuarioModifica, fechaModificacion, categorias));
        }
    ...
    public Producto getByCodigo(int codigo) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            return new Disco(codigo, nombre, descripcion, precio, unidadDeMedida, iva, stock, stockMinimo, foto, usuarioCrea, fechaCreacion, usuarioModifica, fechaModificacion, categorias);
        }
