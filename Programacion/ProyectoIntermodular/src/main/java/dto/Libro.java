...
public class Libro extends Producto {
    ...
    public Libro(String formato, String editorial, String autor, int isbn, int nPaginas, int codigo, int iva, int stock, int stockMinimo, String unidadDeMedida, double precio, String nombre, String descripcion, String foto, LocalDateTime fechaCreacion, LocalDateTime fechaUltimaModificacion, Proveedor proveedor, Usuario creador, Usuario modificador, ArrayList<Categoria> categorias) {
    ...
    public Libro(Producto p, String formato, String editorial, String autor, int isbn, int nPaginas) {
