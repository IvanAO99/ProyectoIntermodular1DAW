...
CREATE TABLE ARTESDORADAS_pedidos (
    ...
    cliente NUMBER(2) NOT NULL REFERENCES ARTESDORADAS_usuarios ON DELETE CASCADE,
    cliente_envio NUMBER(2) NOT NULL,
    direccion_envio NUMBER(2) NOT NULL,
    CONSTRAINT FK_direccion_envio FOREIGN KEY (cliente_envio, direccion_envio) REFERENCES ARTESDORADAS_direcciones ON DELETE CASCADE
);
